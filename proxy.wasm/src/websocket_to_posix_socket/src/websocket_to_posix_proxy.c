...
static int Translate_Socket_Protocol(int protocol)
{
    switch (protocol)
    {
    case MUSL_IPPROTO_IP:
        return IPPROTO_IP;
//    case MUSL_IPPROTO_HOPOPTS: return IPPROTO_HOPOPTS;
    case MUSL_IPPROTO_ICMP:
        return IPPROTO_ICMP;
    case MUSL_IPPROTO_IGMP:
        return IPPROTO_IGMP;
#ifdef IPPROTO_IPIP
    case MUSL_IPPROTO_IPIP:
        return IPPROTO_IPIP;
#endif
    case MUSL_IPPROTO_TCP:
        return IPPROTO_TCP;
    case MUSL_IPPROTO_EGP:
        return IPPROTO_EGP;
    case MUSL_IPPROTO_PUP:
        return IPPROTO_PUP;
    case MUSL_IPPROTO_UDP:
        return IPPROTO_UDP;
    case MUSL_IPPROTO_IDP:
        return IPPROTO_IDP;
#ifdef IPPROTO_TP
    case MUSL_IPPROTO_TP:
        return IPPROTO_TP;
#endif
//    case MUSL_IPPROTO_DCCP: return IPPROTO_DCCP;
    case MUSL_IPPROTO_IPV6:
        return IPPROTO_IPV6;
    case MUSL_IPPROTO_ROUTING:
        return IPPROTO_ROUTING;
    case MUSL_IPPROTO_FRAGMENT:
        return IPPROTO_FRAGMENT;
#ifdef IPPROTO_RSVP
    case MUSL_IPPROTO_RSVP:
        return IPPROTO_RSVP;
#endif
#ifdef IPPROTO_GRE
    case MUSL_IPPROTO_GRE:
        return IPPROTO_GRE;
#endif
    case MUSL_IPPROTO_ESP:
        return IPPROTO_ESP;
    case MUSL_IPPROTO_AH:
        return IPPROTO_AH;
    case MUSL_IPPROTO_ICMPV6:
        return IPPROTO_ICMPV6;
    case MUSL_IPPROTO_NONE:
        return IPPROTO_NONE;
    case MUSL_IPPROTO_DSTOPTS:
        return IPPROTO_DSTOPTS;
#ifdef IPPROTO_MTP
    case MUSL_IPPROTO_MTP:
        return IPPROTO_MTP;
#endif
//    case MUSL_IPPROTO_BEETPH: return IPPROTO_BEETPH;
#ifdef IPPROTO_ENCAP
    case MUSL_IPPROTO_ENCAP:
        return IPPROTO_ENCAP;
#endif
    case MUSL_IPPROTO_PIM:
        return IPPROTO_PIM;
//    case MUSL_IPPROTO_COMP: return IPPROTO_COMP;
    case MUSL_IPPROTO_SCTP:
        return IPPROTO_SCTP;
...
static int Translate_SOL_SOCKET_option(int sockopt)
{
    ...
    case MUSL_SO_ERROR:
        return SO_ERROR;
    case MUSL_SO_DONTROUTE:
        return SO_DONTROUTE;
    case MUSL_SO_BROADCAST:
        return SO_BROADCAST;
    case MUSL_SO_SNDBUF:
        return SO_SNDBUF;
    case MUSL_SO_RCVBUF:
...
#ifdef SO_REUSEPORT
    case MUSL_SO_REUSEPORT:
        return SO_REUSEPORT;
#endif
//  case MUSL_SO_PASSCRED: return SO_PASSCRED;
//  case MUSL_SO_PEERCRED: return SO_PEERCRED;
    case MUSL_SO_RCVLOWAT:
        return SO_RCVLOWAT;
    case MUSL_SO_SNDLOWAT:
        return SO_SNDLOWAT;
    case MUSL_SO_RCVTIMEO:
        return SO_RCVTIMEO;
    case MUSL_SO_SNDTIMEO:
        return SO_SNDTIMEO;
    case MUSL_SO_ACCEPTCONN:
...
#ifndef WIN32
    case MUSL_TCP_FASTOPEN:
        return TCP_FASTOPEN;
#endif
//  case MUSL_TCP_TIMESTAMP: return TCP_TIMESTAMP;
#ifdef TCP_NOTSENT_LOWAT
    case MUSL_TCP_NOTSENT_LOWAT:
...
void Setsockopt(int client_fd, uint8_t *data, uint64_t numBytes)
{
    ...
    case SOL_SOCKET:
        ...
        break;
    case IPPROTO_TCP:
        d->option_name = Translate_IPPROTO_TCP_option(d->option_name);
        break;
    default:
...
void ProcessWebSocketMessageSynchronouslyInCurrentThread(int client_fd, uint8_t *payload, uint64_t numBytes)
{
    ...
    {
    case POSIX_SOCKET_MSG_SOCKET:
        Socket(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_SOCKETPAIR:
        Socketpair(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_SHUTDOWN:
        Shutdown(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_BIND:
        Bind(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_CONNECT:
        Connect(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_LISTEN:
        Listen(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_ACCEPT:
        Accept(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_GETSOCKNAME:
        Getsockname(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_GETPEERNAME:
        Getpeername(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_SEND:
        Send(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_RECV:
        Recv(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_SENDTO:
        Sendto(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_RECVFROM:
        Recvfrom(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_SENDMSG:
        Sendmsg(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_RECVMSG:
        Recvmsg(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_GETSOCKOPT:
        Getsockopt(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_SETSOCKOPT:
        Setsockopt(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_GETADDRINFO:
        Getaddrinfo(client_fd, payload, numBytes);
        break;
    case POSIX_SOCKET_MSG_GETNAMEINFO:
        Getnameinfo(client_fd, payload, numBytes);
        break;
    default:
